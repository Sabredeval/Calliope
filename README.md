...
- **Full-text search inside prose** — the `Ctrl/Cmd+K` search currently matches scene/chapter titles and codex fields; extending it to match and highlight inside manuscript body text would make it a real find-everywhere tool.